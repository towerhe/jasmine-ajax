describe("Jasmine Mock Ajax (for ExtJS)", function() {
  ...
  describe("when simulating a response with request.response", function () {
    describe("and the response is Success", function () {
      ...
      sharedAjaxResponseBehaviorForExtJS_Success(sharedContext);
    });
    ...
    describe("and the status/response code is 0", function () {
      ...
      sharedAjaxResponseBehaviorForExtJS_Failure(sharedContext);
    });
  });
...
function sharedAjaxResponseBehaviorForExtJS_Success(context) {
...
function sharedAjaxResponseBehaviorForExtJS_Failure(context) {
